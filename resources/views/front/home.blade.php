      ...
      <div class="row">
        <div class="col-md-12">
          <div class="text-content">
            <h2>Bienvenue dans l'univers de l'IA</h2>
        ...
        <div class="col-md-6 col-sm-6">
          <a href="{{ route('front_categories') }}">
            <div class="service-item">
              <div class="icon">
                <img width="100" height="100" src="{{ asset('assets/homepage/img/ebrecher.png') }}" alt="">
              </div>
              <h4>Voir les catégories</h4>
            </div>
          </a>
        </div>
        <div class="col-md-6 col-sm-6">
          <a href="{{ route('front_articles') }}">
            <div class="service-item">
              <div class="icon">
                <img width="100" height="100" src="{{ asset('assets/homepage/img/ia.png') }}" alt="">
              </div>
              <h4>Voir les articles</h4>
            </div>
          </a>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          <div class="left-image col-md-4">
            <img src="{{ asset('assets/homepage/img/intelligence-artificielle.png') }}" alt="L' intelligence artificielle">
          </div>
